...
#    257	ATAK_FORWARDER
    ...
    try:
        ...
        j.add_match(_SYSTEMD_UNIT="meshtasticd.service")
        j.seek_tail()
        j.get_previous()
        ...
        message += "  Need to add yourself to the 'systemd-journal' group by running:\n"
        message += f"     sudo usermod -a -G systemd-journal {username}\n"
